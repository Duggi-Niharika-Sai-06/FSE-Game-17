...
const HardGameMode = ({onGameStateChange}) => {
    ...
    const [bestScore, setBestScore] = useState(parseInt(localStorage.getItem("hardHighScore")) || 0);
    ...
    const shuffleEmojis = (emojis) => {
        ...
        const shuffledSubset = shuffledEmojis.slice(0, 48);
    ...
    const onEmojiClick = (emoji) => {
        if (clickedEmojis.includes(emoji)) {
            ...
            if (currentScore + 1 > bestScore) {
                ...
                localStorage.setItem("hardHighScore", (currentScore + 1).toString());
            }
